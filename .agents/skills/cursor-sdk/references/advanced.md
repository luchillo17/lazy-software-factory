...
const agent = Agent.create({
  ...
  agents: {
    "code-reviewer": {
      ...
      prompt:
        "Review code for bugs, security issues, and proven approaches. Be concrete and cite file:line.",
      model: "inherit",
    },
    "test-writer": {
      description: "Writes tests for code changes.",
      prompt:
        "Write comprehensive unit and integration tests. Use the project's test framework.",
    },
  },
});
```
