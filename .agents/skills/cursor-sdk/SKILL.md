...
- **When the user describes a problem the SDK fits but doesn't name it** ("I want a bot that reviews my PRs", "I want a script that asks Cursor questions about my repo"): the SDK isn't yet a confirmed choice. Surface it as a question, briefly, then wait: _"The Cursor SDK is what I'd reach for here — want me to design it that way, or do you have a different runtime in mind?"_ If they confirm, proceed. If they push back or want options, give options.
